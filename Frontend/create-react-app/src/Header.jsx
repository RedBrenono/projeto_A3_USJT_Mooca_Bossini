            ...
            <header className="bg-white shadow-sm border-b">
                <div className="container mx-auto px-6 py-4">
                    <div className="flex justify-between items-center">
                        <Link to="/" className="text-3xl font-bold text-blue-800 mr-4">NumSafe</Link>
                        <nav className="flex space-x-6">
                            ...
                            <Link to="/entrar">
                                <button className="text-black hover:bg-gray-100 rounded-md border border-gray-300 pr-4 pl-4">Entrar</button>
                            </Link>
                        </nav>
                    </div>
                </div>
